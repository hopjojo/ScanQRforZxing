...
import zj.neverland.scandemo.zxing.decode.DecodeThread;
import zj.neverland.scandemo.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		...
		case R.id.restart_preview:
			Log.i("restart_preview","restart_preview");
			// 重新预览
			restartPreviewAndDecode();
			break;
		case R.id.decode_succeeded:
			Log.i("decode_succeeded","decode_succeeded");
			// 解码成功
			state = State.SUCCESS;
		...
		case R.id.decode_failed:
			Log.i("decode_failed","decode_failed");
		...
		case R.id.return_scan_result:
			Log.i("return_scan_result","return_scan_result");
			//扫描结果，返回CaptureActivity处理
			activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
			activity.finish();
			break;
		case R.id.launch_product_query:
			Log.i("launch_product_query","launch_product_query");
